...
//    printf("|before acc_i %d, next_acc_row_i %d\dim_x", acc_i, next_acc_row_i);
...
//        printf("|row acc_i %d, col_i %d\dim_x", acc_i, col_i);
        for (int pa = 0; pa < pair_cell_size; pa++) {
            for (int pb = 0; pb < pair_cell_size; pb++) {
//                printf("|cell tid %d, acc_i %d, col_i %d, pa %d, pb %d, xp1 %f, xp2 %f\dim_x",
